...
namespace App\Tests\Unit\Module\User\Command\JoinByEmail;
...
/**
 * Class RequestTest
 * @package App\Tests\Unit\Module\User\Command\JoinByEmail
 */
class RequestTest extends TestCase
{
    public function testSuccess(): void
    {
        $company = new Company($companyId = CompanyId::generate());
        ...
        self::assertEquals($companyId, $company->getId());
